...
Строка `ЭК в сравнении` объясняет, что выбраны самые дорогие ЭК текущего
расчёта, до 6 позиций, только с публичной ценой Cloud.ru. Дата прайса показана
в строке провайдера этой же таблицы, без отдельной верхней матрицы. На экранах
с бюджетом, стоимостью или сравнением
