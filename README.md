...
- **46 элементов конфигурации** (включая 11 AI-позиций) и формульный движок qty с собственным безопасным DSL.
...
Все 46 элементов конфигурации в `js/domain/seed.js` имеют источник цены в inline-комментарии: 45 позиций с `pricePerUnit > 0` и 1 явно бесплатная позиция `traffic-ingress-tb` (входящий трафик, 0 ₽/ТБ):
