...
Локальное web-приложение для оценки инфраструктуры и совокупной стоимости (CAPEX + OPEX) программного продукта по 5 стендам: **DEV · ИФТ · ПСИ · ПРОМ · Нагрузка**.
...
Помогает архитектору / тимлиду / RFP-инженеру за 5–15 минут собрать предварительный TCO для продукта на этапе «бизнес ставит вопрос — нужны цифры».
...
- **Светлая и тёмная темы** с переключателем в TopBar.
