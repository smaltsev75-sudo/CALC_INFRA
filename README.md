...
- **Корневые причины бюджета** отдельным окном из Детализации: top-X параметров,
  которые дают наибольшую экономию при проверочном пересчёте, и ЭК, которые
  меняются вслед за ними. В PDF этот аналитический блок не печатается.
