...
пользовательском UI рядом с прайсом показывается дата актуальности и версия
provider JSON, а в прайс-бенчмарке есть матрица доверия Cloud.ru vs Yandex vs
VK по ключевым типам ресурсов. На экранах с бюджетом, стоимостью или сравнением
