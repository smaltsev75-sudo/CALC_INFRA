...
**Версия 2.20.28** (expanded business realism gates + provider confidence summary + UserManual validation checklist + Details price/qty PDF guard). Schema v20.
