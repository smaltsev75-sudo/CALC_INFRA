...
**Версия 2.20.29** (VK Cloud source-level pricelist bundle + quality-aware provider readiness + UserManual/Maintainer docs update). Schema v20.
