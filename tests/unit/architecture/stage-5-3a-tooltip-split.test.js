 ...
 * Покрывает 12 settings + 8 Quick Start полей, ~20 ключей в UI_TOOLTIPS_SHORT.
 *
 * Инвариант:
...
const QS_KEYS = [
    ...
    'qs.geography', 'qs.pdn', 'qs.activity', 'qs.ai_used'
];
...
describe('Stage 5.3.A / UI_TOOLTIPS_SHORT — наполнение каталога', () => {
    ...
    it('UI_TOOLTIPS_SHORT покрывает все 8 Quick Start-ключей', () => {
